...
module.exports = function fails(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.fails()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.fails()` called with an Error:', optionalData);
